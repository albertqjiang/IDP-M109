...
int find_ball_no(int* golf_balls, int delivery_point) {
    // TODO: implement and migrate it
    return 0;
}

int main() {
	// robot initialization moved to constructor of the class
	// Both WiFi and arm local control supported
    ...
    rlink.mc->forward_with_lf(0);                    //go to 1st delivery point
